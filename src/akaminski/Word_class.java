...
public class Word_class {
    ...
    //Dodawanie do list
    private void Dodaj(String[]Tabela, List<String>list){
        for(String x: Tabela)
            list.add(x);
    }

    //Wyswietl
    private void Wyswietl(List<String>list){
    ...
    private void Edytuj(List<String>list,List<String>list2){
    ...
    private void DodajList(List<String>list,List<String>list2){
        list.addAll(list2);
    }
    ...
    //Usuwanie
    private void Usun(List<String>list){
    ...
    private void Con(List<String>list,String[]Tabela ){
    ...
    private void Cop(List<String>listdest,List<String>listsrc ){
    ...
    //Addall Collection
    private void addall(List<String>srclist,String[]Tabela ){
